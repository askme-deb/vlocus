...
@section('content')
    ...
    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data" class="needs-validation"
        novalidate>
        @csrf
        <div class="row">
            <!-- General Info -->
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            @if ($setting && $setting->hasMedia('logo'))
                                <img src="{{ $setting->getFirstMediaUrl('logo') }}" alt="Logo" height="60"
                                    class="mt-2">
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            @if ($setting && $setting->hasMedia('favicon'))
                                <img src="{{ $setting->getFirstMediaUrl('favicon') }}" alt="Logo" height="60"
                                    class="mt-2">
                            @endif
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cab_search_radius" name="cab_search_radius"
                                value="{{ old('cab_search_radius', $setting->cab_search_radius ?? '') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nearby_search_radius"
                                ...
                                value="{{ old('nearby_search_radius', $setting->nearby_search_radius ?? '') }}">
                        </div>

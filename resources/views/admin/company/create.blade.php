...
@section('content')
        ...
        <div class="ms-auto">
            @can('Company Create')
                <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                    <a class="btn btn-primary px-4" href="{{ route('company.index') }}"><i
    ...
    <form class="needs-validation" action="{{ route('company.store') }}" method="post" novalidate enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-9">
                <div class="card mt-4">

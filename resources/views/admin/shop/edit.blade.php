                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('shop_street_address', $data->shop_street_address) }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('shop_pincode', $data->shop_pincode) }}" name="shop_pincode"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('shop_district', $data->shop_district) }}" name="shop_district"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('shop_state', $data->shop_state) }}" name="shop_state"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ old('shop_country', $data->shop_country ?? 'India') }}"
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_registration_number">Shop Registration Number
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                    value="{{ old('shop_registration_number', $data->shop_registration_number) }}"

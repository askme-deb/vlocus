...
@section('content')
    ...
    <form method="POST" action="{{ route('vehicle.store') }}" enctype="multipart/form-data" class="needs-validation"
        novalidate>
        @csrf
        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" name="vehicle_condition" id="vehicle_condition"
                                            required>
                                            <option value="0"
                                                {{ old('vehicle_condition') == '0' ? 'selected' : '' }}>New</option>
                                            <option value="1"
                                                {{ old('vehicle_condition') == '1' ? 'selected' : '' }}>Second Hand
                                            </option>
                                        </select>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" name="engine_type" id="engine_type" required>
                                            <option value="0" {{ old('engine_type') == '0' ? 'selected' : '' }}>
                                                Pyston</option>
                                            <option value="1" {{ old('engine_type') == '1' ? 'selected' : '' }}>
                                                Electric
                                            </option>
                                        </select>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" name="transmisssion" id="transmisssion" required>
                                            <option value="0" {{ old('transmisssion') == '0' ? 'selected' : '' }}>
                                                Automactic
                                            </option>
                                            <option value="1" {{ old('transmisssion') == '1' ? 'selected' : '' }}>
                                                Manul</option>
                                        </select>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" name="left_hand_drive" id="left_hand_drive" required>
                                            <option value="0" {{ old('left_hand_drive') == '0' ? 'selected' : '' }}>
                                                No</option>
                                            <option value="1" {{ old('left_hand_drive') == '1' ? 'selected' : '' }}>
                                                Yes</option>
                                        </select>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" name="hybird" id="hybird" required>
                                            <option value="0" {{ old('hybird') == '0' ? 'selected' : '' }}>No
                                            </option>
                                            <option value="1" {{ old('hybird') == '1' ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                        <div class="invalid-feedback">Please select an option.</div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" name="ac_status" id="ac_status">
                                            ...
                                            <option value="AC" {{ old('ac_status') == 'AC' ? 'selected' : '' }}>AC
                                            </option>
                                            <option value="Non AC" {{ old('ac_status') == 'Non AC' ? 'selected' : '' }}>
                                                Non AC</option>
                                        </select>

...
@section('content')
    ...
    <form method="POST" action="{{ route('vehicle.update') }}" class="needs-validation" novalidate>
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header text-center">Update Vehicle Registration Details</div>
                    <div class="card-body">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                @if ($data->rc_verified_at)
                                    <div class="small text-success mt-1">
                                        ...
                                        RC verified on {{ $data->rc_verified_at->format('d M Y, H:i') }}
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        @include('admin.vehicle._rc_fields', ['data' => $data])

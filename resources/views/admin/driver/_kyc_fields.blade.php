...
<div class="form-group row mb-3">
    ...
    <div class="col-md-9">
        ...
        <input type="hidden" name="aadhaar_verification_data" id="aadhaar_verification_data" value="{{ $aadhaarPayload }}">
...
<div class="form-group row mb-3">
    ...
    <div class="col-md-9">
        ...
        <input type="hidden" name="pan_verification_data" id="pan_verification_data" value="{{ $panPayload }}">
    </div>
</div>

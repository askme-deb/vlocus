<?php
    ...
    if (!function_exists('calculate_duration')) {
        ...
        {
            $start = Carbon::parse($departure_time);
            $end = Carbon::parse($arrival_time);
    ...
    if (!function_exists('toDbDate')) {
        /**
         * Convert dd/mm/YYYY to YYYY-mm-dd (DB format)
         */
    ...
    if (!function_exists('fromDbDate')) {
        /**
         * Convert YYYY-mm-dd (DB format) to dd/mm/YYYY (Display format)
         */

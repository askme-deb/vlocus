...
<?php $__env->startSection('title', 'Dispatch Details Report'); ?>
...
<div class="dispatch-report">
    ...
    <div class="card panel-card">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('reports.dispatchDetails')); ?>" class="filter-toolbar row g-3 align-items-end mb-4">
                <div class="col-md-3">
                ...
                <div class="col-md-2 text-end">
                    <a href="<?php echo e(route('reports.dispatchDetails')); ?>" class="btn btn-outline-secondary btn-filter">Reset</a>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($row['order_datetime']); ?></td>
                                <td><?php echo e($row['invoice_no']); ?></td>
                                <td><?php echo e($row['from_location']); ?></td>
                                <td><?php echo e($row['to_location']); ?></td>
                                <td><?php echo e($row['route']); ?></td>
                                <td><?php echo e($row['district']); ?></td>
                                <td><?php echo e($row['distance']); ?></td>
                                <td><?php echo e($row['vehicle_number']); ?></td>
                                <td><?php echo e($row['driver_number']); ?></td>
                                ...
                                <td><?php echo e($row['delivered_at']); ?></td>
                                <td><?php echo e($row['delay']); ?></td>
                                <td>
                                    <a class="bill-link" title="View Bill"
                                        href="<?php echo e(route('delivery.invoice', [$row['delivery_schedule_id'], $row['shop_id']])); ?>"
                                        target="_blank">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\vlocus\resources\views/admin/reports/dispatch_details.blade.php ENDPATH**/ ?>
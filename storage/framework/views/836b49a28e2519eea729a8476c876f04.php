...
<?php $__env->startSection('content'); ?>
    ...
    <form class="needs-validation" action="<?php echo e(route('shop.update', $data->id)); ?>" method="post" novalidate
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(old('shop_name', $data->shop_name)); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_contact_person_name', $data->shop_contact_person_name)); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_address">Shop Address <span
                                        class="text-danger">*</span></label>
                                <textarea name="shop_address" id="shop_address"  class="form-control" placeholder="Enter shop address" id="shop_address" required><?php echo e(old('shop_address', $data->shop_address)); ?></textarea>
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="tel" minlength="10" maxlength="10" pattern="[0-9]{10}" class="form-control"
                                    value="<?php echo e(old('shop_contact_person_phone', $data->shop_contact_person_phone)); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_street_address', $data->shop_street_address)); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_pincode', $data->shop_pincode)); ?>" name="shop_pincode"
                                    id="shop_pincode" maxlength="6" placeholder="Enter pin code">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_district', $data->shop_district)); ?>" name="shop_district"
                                    id="shop_district" placeholder="Enter district">
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_state">State</label>
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_state', $data->shop_state)); ?>" name="shop_state"
                                    id="shop_state" placeholder="Enter state">
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_country">Country</label>
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_country', $data->shop_country ?? 'India')); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_registration_number">Shop Registration Number
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_registration_number', $data->shop_registration_number)); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_latitude', $data->shop_latitude)); ?>" name="shop_latitude"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo e(old('shop_longitude', $data->shop_longitude)); ?>" name="shop_longitude"
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200"
                                    src="<?php echo e($data->getFirstMediaUrl('shop-image')); ?>" data-holder-rendered="true"
                                    style="display: <?php echo e(is_have_image($data->getFirstMediaUrl('shop-image'))); ?>;">
                            </div>
                            <div class="mb-0">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline1" name="is_visible"
                                        class="form-check-input" value="1" <?php echo e(check_uncheck($data->is_visible, 1)); ?>>
                                    <label class="form-check-label" for="customRadioInline1">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" id="customRadioInline2" name="is_visible"
                                        class="form-check-input" value="0" <?php echo e(check_uncheck($data->is_visible, 0)); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\vlocus\resources\views/admin/shop/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="needs-validation" action="<?php echo e(route('employee.store')); ?>" method="post" novalidate
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <?php echo $__env->make('admin.partials.pan-aadhaar-verification-fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <select class="form-control input-height single-select-field" name="branch_id" required>
                                        ...
                                        <?php $__currentLoopData = $branchs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"
                                                <?php if(old('branch_id') == $item->id): ?> selected <?php endif; ?>><?php echo e($item->name); ?> <?php if (! (auth()->user()->hasRole('Company'))): ?> | <?php echo e($item->branch?->company?->name ?? 'N/A'); ?> <?php endif; ?></option>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <?php echo $__env->make('admin.partials.pan-aadhaar-verification-scripts', [
        'panVerifyRoute' => 'employee.verifyPan',
        'aadhaarSendOtpRoute' => 'employee.aadhaarSendOtp',
        'aadhaarVerifyOtpRoute' => 'employee.aadhaarVerifyOtp',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\vlocus\resources\views/admin/employee/create.blade.php ENDPATH**/ ?>
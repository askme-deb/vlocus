...
<head>
    ...
    <style>
        ...
        /* Background Image */
        body {
            background-image: url('<?php echo e(asset('assets/dashboard-assets/assets/images/auth/bg.jpg')); ?>');
        ...
        <div class="card my-5 col-xl-6 col-xxl-6 mx-auto rounded-4 overflow-hidden p-4">
            <div class="row g-4">
                <div class="col-lg-12 d-flex">
                    <div class="card-body">
                        <img src="<?php echo e(asset('assets/dashboard-assets/assets/images/logo.png')); ?>" class="mb-4" width="345" alt="">
...
</html><?php /**PATH D:\projects\vlocus\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
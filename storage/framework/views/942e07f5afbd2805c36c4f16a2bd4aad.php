...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                <a class="btn btn-primary px-4" href="<?php echo e(route('shop.index')); ?>"><i
    ...
    <form class="needs-validation" action="<?php echo e(route('shop.store')); ?>" method="post" novalidate
        enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header text-center">Add Shop Details</div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(old('shop_name')); ?>" name="shop_name"
                                    id="shop_name" placeholder="Enter shop name" required>
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_registration_number">Shop Registration Number
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_registration_number')); ?>"
                                    name="shop_registration_number" id="shop_registration_number"
                                    placeholder="Enter shop registration number" required>
                                <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please enter shop registration number.</div>
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_contact_person_name">Shop Contact Person Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_contact_person_name')); ?>"
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_address">Shop Address <span
                                        class="text-danger">*</span></label>
                                <textarea name="shop_address" id="shop_address" class="form-control" placeholder="Enter shop address" id="shop_address"
                                    required><?php echo e(old('shop_address')); ?></textarea>
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="tel" minlength="10" maxlength="10" pattern="[0-9]{10}" class="form-control"
                                    value="<?php echo e(old('shop_contact_person_phone')); ?>" name="shop_contact_person_phone"
                                    id="shop_contact_person_phone" placeholder="Enter shop contact person phone no."
                                    required>
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_street_address">Street Address</label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_street_address')); ?>"
                                    name="shop_street_address" id="shop_street_address"
                                    placeholder="Enter street address">
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_pincode">Pin Code</label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_pincode')); ?>"
                                    name="shop_pincode" id="shop_pincode" maxlength="6" placeholder="Enter pin code">
                                <small id="pincode_status" class="text-muted"></small>
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_district">District</label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_district')); ?>"
                                    name="shop_district" id="shop_district" placeholder="Enter district">
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_state">State</label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_state')); ?>"
                                    name="shop_state" id="shop_state" placeholder="Enter state">
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_country">Country</label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_country', 'India')); ?>"
                                    name="shop_country" id="shop_country" placeholder="Enter country">
                            </div>

                            <div class="mb-3 col-md-6">
                                <label class="form-label" for="shop_latitude">Latitude</label>
                                <input type="text" class="form-control" value="<?php echo e(old('shop_latitude')); ?>"
                                    name="shop_latitude" id="shop_latitude" placeholder="Enter latitude">
                                <div class="valid-feedback">Looks good!</div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(old('shop_longitude')); ?>"
                                    name="shop_longitude" id="shop_longitude" placeholder="Enter longitude">
                                <div class="valid-feedback">Looks good!</div>
            ...
            <div class="col-md-3">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header text-center">Add Shop Image</div>
                        <div class="card-body">
                            <div class="mb-3">
       ...
       // const GOOGLE_MAPS_API_KEY = "<?php echo e(env('GOOGLE_MAPS_API_KEY')); ?>";
        $(document).ready(function() {
           ...
           // var apiKey = GOOGLE_MAPS_API_KEY;
            ...
            var $pincode = $('#shop_pincode');
            var $pincodeStatus = $('#pincode_status');
            ...
            $pincode.on('input', function() {
                ...
                $pincodeStatus.text('Looking up pin code...');

                $.get('https://api.postalpincode.in/pincode/' + pin, function(response) {
                    var result = response && response[0];

                    if (result && result.Status === 'Success' && result.PostOffice && result.PostOffice
                        .length) {
                        var office = result.PostOffice[0];

                        $('#shop_district').val(office.District || '');
                        $('#shop_state').val(office.State || '');
                        $('#shop_country').val(office.Country || 'India');
                        $pincodeStatus.text('Pin code found: ' + (office.Name || ''));
                    } else {
                        $pincodeStatus.text('No details found for this pin code.');
                    }
                }).fail(function() {
                    $pincodeStatus.text('Unable to fetch pin code details.');
                });
            });
        });
    </script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\vlocus\resources\views/admin/shop/create.blade.php ENDPATH**/ ?>
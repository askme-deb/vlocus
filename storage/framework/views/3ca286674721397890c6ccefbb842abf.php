...
<div class="task-report">
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3 mb-3">
        <?php $__currentLoopData = $kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <a href="<?php echo e(route('reports.taskReport', array_merge(request()->except(['status','page']), ['status' => $key]))); ?>" class="text-decoration-none">
                    <div class="kpi-card <?php echo e($status === $key ? 'is-active' : ''); ?>" style="--kpi-accent: <?php echo e($kpi['accent']); ?>;">
                        <span class="kpi-bar"></span>
                        <div class="card-body">
                            <div>
                                <div class="kpi-label"><?php echo e($kpi['label']); ?></div>
                                <div class="kpi-value"><?php echo e($counts[$key]); ?></div>
                                <div class="kpi-sub"><?php echo e(number_format(($counts[$key] / $totalTasks) * 100, 1)); ?>% of total</div>
                            </div>
                            <div class="kpi-icon"><i class='bx <?php echo e($kpi['icon']); ?>'></i></div>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="card panel-card h-100">
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <div class="text-center">
                        <div class="kpi-value" style="font-size:38px;"><?php echo e($acceptanceRate); ?>%</div>
                        <div class="kpi-sub mb-3">of decided tasks were accepted</div>
                        <div class="progress" style="height:10px; border-radius:999px;">
                            <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo e($acceptanceRate); ?>%; border-radius:999px;"></div>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            <span class="kpi-sub"><?php echo e($counts['accepted']); ?> accepted</span>
                            <span class="kpi-sub"><?php echo e($counts['rejected']); ?> rejected</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card panel-card">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('reports.taskReport')); ?>" class="filter-toolbar row g-3 align-items-end mb-4">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="search" value="<?php echo e($search); ?>" class="form-control" placeholder="Search...">
                </div>
                <div class="col-md-2 text-end">
                    <a href="<?php echo e(route('reports.taskReport')); ?>" class="btn btn-outline-secondary btn-filter">Reset</a>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><span class="lr-code"><?php echo e($report->lr_no); ?></span></td>
                                <td>
                                    <span class="shop-avatar"><?php echo e(strtoupper(substr($report->shop->shop_name ?? '?', 0, 1))); ?></span>
                                    <?php echo e($report->shop->shop_name ?? 'N/A'); ?>

                                </td>
                                <td><?php echo e($report->deliverySchedule->driver->name ?? 'N/A'); ?></td>
                                <td><?php echo e($report->deliverySchedule->vehicle->vehicle_number ?? 'N/A'); ?></td>
                                <td><?php echo e($report->deliverySchedule->delivery_date ?? 'N/A'); ?></td>
                                <td>
                                    <?php if($report->is_delivered): ?>
                                        <span class="status-pill pill-primary"><i class='bx bx-package'></i> Delivered</span>
                                    <?php elseif($report->is_cancelled): ?>
                                ...
                                <td><?php echo e($report->accepted_at ? format_datetime($report->accepted_at) : '-'); ?></td>
                                <td><?php echo e($report->delivered_at ? format_datetime($report->delivered_at) : '-'); ?></td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (chartEl && window.ApexCharts) {
            var options = {
                ...
                series: [
                    <?php echo e($counts['accepted']); ?>,
                    <?php echo e($counts['rejected']); ?>,
                    <?php echo e($counts['delivered']); ?>,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\vlocus\resources\views/admin/reports/task_report.blade.php ENDPATH**/ ?>
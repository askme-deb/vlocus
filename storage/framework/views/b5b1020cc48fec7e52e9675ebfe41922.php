...
<script>
    ...
    $('#verifyPanBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route($panVerifyRoute)); ?>',
            type: 'POST',
            data: {
    ...
    $('#sendAadhaarOtpBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route($aadhaarSendOtpRoute)); ?>',
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
    ...
    $('#verifyAadhaarOtpBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route($aadhaarVerifyOtpRoute)); ?>',
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                otp: otp,
...
<?php /**PATH D:\projects\vlocus\resources\views/admin/partials/pan-aadhaar-verification-scripts.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['Shop Bulk Upload', 'Shop Bulk Upload Template'])): ?>
                ...
                <div class="accordion-body">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center" style="border: none;">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Shop Bulk Upload Template')): ?>
                                <a href="<?php echo e(route('shop.template.download')); ?>" class="btn btn-sm btn-success">
                                    <i class="bi bi-download"></i> Download Template
                                </a>
                            <?php endif; ?>
                        </div>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Shop Bulk Upload')): ?>
                        <div class="card-body">
                            <form action="<?php echo e(route('shop.bulk.upload')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php if($shops->isNotEmpty()): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($item->shop_registration_number); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\vlocus\resources\views/admin/shop/index.blade.php ENDPATH**/ ?>